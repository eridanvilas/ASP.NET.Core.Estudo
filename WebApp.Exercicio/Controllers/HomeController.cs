...
using WebApp.Exercicio.Models;

namespace WebApp.Exercicio.Controllers
{
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    if (await _userManager.CheckPasswordAsync(user, model.Password))
                    {
                        ...
                        {
                            ModelState.AddModelError("", "E-Mail nao esta valido!");
                            return View();
                        }
                    ...
                    if (await _userManager.IsLockedOutAsync(user))
                    {
                        ...
                        var resetURl = Url.Action("ResetPassword", "Home",
                            new { token = token, email = model.UserName }, Request.Scheme);

                        System.IO.File.WriteAllText("UserLocked.txt", resetURl);
                    }
        ...
        public async Task<IActionResult> TwoFactor(TwoFactorModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(user != null)
                {
                    ...
                    ModelState.AddModelError("", "Isvalid Token");

                    return View();
                }
                ModelState.AddModelError("", "Isvalid Request");
